...
htmlhelp_basename = 'Brian2GeNNdoc'
...
latex_documents = [
  ('index', 'Brian2GeNN.tex', 'Brian2GeNN Documentation',
   'Brian2GeNN authors', 'manual'),
]
...
man_pages = [
    ('index', 'brian2genn', 'Brian2GeNN Documentation',
     ['Brian2GeNN authors'], 1)
]
...
texinfo_documents = [
  ('index', 'Brian2GeNN', 'Brian2GeNN Documentation',
   'BrianGeNN authors', 'Brian2GeNN', 'One line description of project.',
   'Miscellaneous'),
]
